<x-admin-layout title="TAMBAH USER">
    <form action="/admin/dashboard/users" method="POST">
        ...
        <div class="w-1/2 mb-10">
            ...
            <div class="form-group pb-4">
                <label for="role" class="block mb-1 font-semibold text-primary-1">Role</label>
                <select name="role" id="role" class="@error('password') is-invalid @enderror form-control border border-slate-700 focus:border-none w-full rounded-lg py-1 px-1 focus:outline-none focus:ring-1 focus:ring-accent focus:outline-secondary-1 focus:outline-2 focus:outline-offset-0">
